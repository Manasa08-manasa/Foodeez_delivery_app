      ...
      child: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            padding: Responsive.screenPadding(context, horizontal: 30, vertical: 20),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Flexible(child: Text('Delivered!', style: AppText.display(size: Responsive.fontSize(context, 25)))),
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Great job, ${app.displayName(riderName)}. Order #${req.orderId} handed over to ${req.customerName.split(' ').first}.',
                      textAlign: TextAlign.center,
                      style: AppText.body(size: 13.5, color: AppColors.bodyGrey, height: 1.5),
                    ),
                  ),
                  Container(
